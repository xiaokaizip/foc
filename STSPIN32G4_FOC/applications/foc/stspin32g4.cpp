...
HAL_StatusTypeDef STSPIN32G4_readReg(STSPIN32G4_HandleTypeDef *hdl, uint8_t regAddr, uint8_t *value) {
    ...
    status = HAL_I2C_Mem_Read(hdl->i2cHdl, STSPIN32G4_I2C_ADDR, (uint16_t) regAddr, 1, value, 1,
                              STSPIN32G4_I2C_TIMEOUT);
    return status;
}
...
HAL_StatusTypeDef STSPIN32G4_writeReg(STSPIN32G4_HandleTypeDef *hdl, uint8_t regAddr, uint8_t value) {
    ...
    status =
            HAL_I2C_Mem_Write(hdl->i2cHdl, STSPIN32G4_I2C_ADDR, (uint16_t) regAddr, 1, &value, 1,
                              STSPIN32G4_I2C_TIMEOUT);
    return status;
}
...
HAL_StatusTypeDef STSPIN32G4_setVCC(STSPIN32G4_HandleTypeDef *hdl, STSPIN32G4_confVCC vcc) {
    ...
    if (status == HAL_OK) {
        switch (vcc.voltage) {
            case STSPIN32G4_confVCC::_EXT: i2cReg |= STSPIN32G4_I2C_VCC_DIS;
                break;

            case STSPIN32G4_confVCC::_8V:
                i2cReg &= ~(STSPIN32G4_I2C_VCC_DIS | STSPIN32G4_I2C_VCC_VAL_3);
                i2cReg |= STSPIN32G4_I2C_VCC_VAL_0;
                break;

            case STSPIN32G4_confVCC::_10V:
                i2cReg &= ~(STSPIN32G4_I2C_VCC_DIS | STSPIN32G4_I2C_VCC_VAL_3);
                i2cReg |= STSPIN32G4_I2C_VCC_VAL_1;
                break;

            case STSPIN32G4_confVCC::_12V:
                i2cReg &= ~(STSPIN32G4_I2C_VCC_DIS | STSPIN32G4_I2C_VCC_VAL_3);
                i2cReg |= STSPIN32G4_I2C_VCC_VAL_2;
                break;

            case STSPIN32G4_confVCC::_15V:
...
HAL_StatusTypeDef STSPIN32G4_getVCC(STSPIN32G4_HandleTypeDef *hdl, STSPIN32G4_confVCC *vcc) {
    ...
    if (status == HAL_OK) {
        if (i2cReg & STSPIN32G4_I2C_VCC_DIS) {
            vcc->voltage = STSPIN32G4_confVCC::_EXT;
        } else {
            switch (i2cReg & STSPIN32G4_I2C_VCC_VAL_3) {
                case STSPIN32G4_I2C_VCC_VAL_0: vcc->voltage = STSPIN32G4_confVCC::_8V;
                    break;

                case STSPIN32G4_I2C_VCC_VAL_1: vcc->voltage = STSPIN32G4_confVCC::_10V;
                    break;

                case STSPIN32G4_I2C_VCC_VAL_2: vcc->voltage = STSPIN32G4_confVCC::_12V;
                    break;

                case STSPIN32G4_I2C_VCC_VAL_3: vcc->voltage = STSPIN32G4_confVCC::_15V;
                    break;
...
HAL_StatusTypeDef STSPIN32G4_setVDSP(STSPIN32G4_HandleTypeDef *hdl, STSPIN32G4_confVDSP vdsp) {
    ...
    if (status == HAL_OK) {
        ...
        switch (vdsp.deglitchTime) {
            case STSPIN32G4_confVDSP::_6us: i2cReg |= STSPIN32G4_I2C_VDS_P_DEG_0;
                break;

            case STSPIN32G4_confVDSP::_4us: i2cReg |= STSPIN32G4_I2C_VDS_P_DEG_1;
                break;

            case STSPIN32G4_confVDSP::_3us: i2cReg |= STSPIN32G4_I2C_VDS_P_DEG_2;
                break;

            case STSPIN32G4_confVDSP::_2us: i2cReg |= STSPIN32G4_I2C_VDS_P_DEG_3;
                break;
...
HAL_StatusTypeDef STSPIN32G4_getVDSP(STSPIN32G4_HandleTypeDef *hdl, STSPIN32G4_confVDSP *vdsp) {
    ...
    if (status == HAL_OK) {
        switch (i2cReg & STSPIN32G4_I2C_VDS_P_DEG_3) {
            case STSPIN32G4_I2C_VDS_P_DEG_0: vdsp->deglitchTime = STSPIN32G4_confVDSP::_6us;
                break;

            case STSPIN32G4_I2C_VDS_P_DEG_1: vdsp->deglitchTime = STSPIN32G4_confVDSP::_4us;
                break;

            case STSPIN32G4_I2C_VDS_P_DEG_2: vdsp->deglitchTime = STSPIN32G4_confVDSP::_3us;
                break;

            case STSPIN32G4_I2C_VDS_P_DEG_3: vdsp->deglitchTime = STSPIN32G4_confVDSP::_2us;
                break;
